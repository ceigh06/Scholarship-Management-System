...
<div class="dashboard-container">
    <div class="top-section">
        ...
        <div class="quick-actions">
            <h3>Quick Actions</h3>
            <a href="#" class="action-btn">Approve Scholarships</a>
    ...
    <div class="charts-section">
        <div class="chart-container">
            ...
            <div class="chart-placeholder"><span>line graph here</span></div>
        </div>
        <div class="chart-container">
            <h4>Distribution</h4>
            <div class="chart-placeholder"><span>donut chart here</span></div>
        </div>
    </div>
</div>